        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-gray-400 leading-loose text-lg mb-6">
              ولدت ELOR من شغف عميق بالجمال الإماراتي الأصيل. لاحظنا أن السوق يفتقر إلى منتجات تجمع بين فخامة المكونات الطبيعية النادرة وأحدث ما توصل إليه علم العناية بالبشرة.
            </p>
            <p className="text-gray-400 leading-loose text-lg">
              بدأت رحلتنا في مختبراتنا الخاصة، حيث أمضينا سنوات في البحث عن "الخلاصات المثالية". لم نكن نبحث عن مجرد كريم أو سيروم، بل كنا نصيغ "تجربة ملكية" تعيد تعريف مفهوم العناية الذاتية للمرأة التي لا تقبل بأقل من الأفضل.
            </p>
          </div>
