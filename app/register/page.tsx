      ...
      <div className="hidden lg:block w-1/2 relative">
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-center px-16">
          ...
          <p className="text-xl text-gray-200 max-w-md leading-relaxed">
            انضمي إلى نخبة عملاء ELOR. أنشئي حسابكِ الآن لتجربة تسوق لا تُنسى وللحصول على عروضنا الحصرية.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-300">كلمة المرور (يجب أن تكون 6 أحرف على الأقل)</label>
              <div className="relative">
                <input 
                  type="password" 
                  value={password}
          ...
          <p className="text-center text-gray-400 mt-8">
            لديكِ حساب بالفعل؟ <Link href="/login" className="text-gold font-bold hover:underline">تسجيل الدخول</Link>
          </p>
        </div>
      </div>
    </main>
